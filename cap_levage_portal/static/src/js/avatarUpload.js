odoo.define('cap_levage_portal_avatar.main', function (require) {
    'use strict';
    ...
    publicWidget.registry.PortalAvatar = publicWidget.Widget.extend({
        selector: '#cap_levage_portal_avatar',
        read_events: {
            'click .cap_levage_portal_avatar_edit': '_onEditAvatarClick',
            'change .cap_levage_portal_avatar_upload': '_onAvatarUploadChange',
            'click .cap_levage_portal_avatar_clear': '_onClearAvatarClick',
        },
        ...
        _onEditAvatarClick: function (ev) {
            ev.preventDefault();
            $(ev.currentTarget).closest('form').find('.cap_levage_portal_avatar_upload').trigger('click');
        },
